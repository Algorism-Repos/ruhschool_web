    ...
    return(
        <>
                ...
                <div ref={containerRef} id="horizontal-container " className ="flex flex-row h-screen">
                    ...
                    <div className="flex flex-row justify-between items-center w-screen relative shrink-0 content">
                        ...
                        <div className = "w-3/4 h-full">
                            <img src={navimage_3} className="w-full h-full mr-12 object-contain"/>
                        </div>
                    </div> 
                </div>
            </div>
                ...
                <div className = "carousel relative" ref={bannerRef} >
                    <div className = "contentContainer" >
                        ...
                        <motion.div className="images relative" style = { { x } }>
                                    ...
                                    {/* Banner 1 */}
                                    <motion.div initial = {{opacity: 0, y: 150}} whileInView={{opacity: 1, y:0, threshold: 0.99}} transition={{duration: 1, ease: "easeOut"}}>
                   ...
                   <div className = "w-[400px]">
                    ...
                    <div className="hidden sm:block">
                        <div className="flex flex-col gap-y-3 items-end">
                            <h5 className=" font-causten font-bold sm:font-medium text-orange sm:text-[28px] text-[40px] sm:leading-[71px] leading-[43px] w-[250px] sm:w-[592px]">Stories of <span className="font-hugme sm:font-aelyn !font-bold text-brown text-[36px]">community & continuity</span></h5>
                            <p className="font-causten font-normal sm:text-[24px] text-[16px] text-black sm:w-[597px] w-[250px] ">This space, rich with history, has embraced generations—your grandparents once studied here, and today, Ruh’lers carry forward the legacy of love and discovery.</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="max-w-[992px] mx-auto mt-16 sm:my-52 overflow-x-hidden" data-aos= "fade-up">
                <div className="flex flex-row items-center relative flex-wrap">
                    ...
                    <div className="bg-brown flex flex-col sm:px-16 sm:py-20 py-3 px-5 w-[361px] overflow-hidden h-[424px] mx-auto sm:w-[502px] sm:h-[602px] order-1 sm:order-2 sm:absolute right-[-50px] z-0">
                        ...
                        <h5 className="font-caveat text-[28px] leading-[33px] text-yellow sm:mt-12 mt-9">Srisha Mohandoss</h5>
                        <p className="font-causten text-[14px] font-extralight text-offwhite w-[221px] sm:w-full">Co-Founder, Ruh Continuum School & Ruh Early Years</p>
            ...
            <div className="bg-home-animation-mobile sm:bg-home-animation bg-cover relative h-[362px] sm:h-[1178px] py-16  w-full overflow-hidden mt-16 sm:mt-0 flex flex-shrink-0 gap-x-44 ">
                ...
                >
                    <motion.img initial = {{ y: "100%"}} animate = {{y: 0}} transition={{duration:20, repeat: Infinity}} src={intuitive} alt="animation_elements" className="w-[98.42px] h-[31.68px] sm:w-[320px] sm:h-[103px] absolute left-[30%] top-[15%]"/>
                    <img src={belonging} alt="animation_elements" className="w-[98.42px] h-[31.68px] sm:w-[320px] sm:h-[103px] absolute left-[70%] top-[30%]"/>
                ...
                <motion.div
                    ...
                    className = "relative w-full h-full shrink-0"
                >
                    <img src={intuitive} alt="animation_elements" className="w-[98.42px] h-[31.68px] sm:w-[320px] sm:h-[103px] absolute left-[30%] top-[15%]"/>
                    <img src={belonging} alt="animation_elements" className="w-[98.42px] h-[31.68px] sm:w-[320px] sm:h-[103px] absolute left-[70%] top-[30%]"/>
                    <img src={open_ended} alt="animation_elements" className="w-[98.42px] h-[31.68px] sm:w-[320px] sm:h-[103px] absolute left-0 top-[40%]"/>
                    <img src={play_based} alt="animation_elements" className="w-[98.42px] h-[31.68px] sm:w-[320px] sm:h-[103px] absolute right-0 top-[50%] "/>
                    <img src={mindful_orange} alt="animation_elements" className="w-[98.42px] h-[31.68px] sm:w-[320px] sm:h-[103px] absolute left-[30%] top-[60%] "/>
            ...
            <div className="max-w-screen-xl mx-auto mt-20" data-aos= "fade-up">
                <div className="flex flex-col sm:flex-row items-center gap-x-24 justify-center">
                    ...
                    <div className = "relative w-[325px] h-[481px] sm:w-[481px] sm:h-[712px] order-2 sm:order-1 sm:mt-0 mt-9 ">
                        <img src = {kid_image_without} alt= "kid-image" className = "w-[215px] h-[341px] sm:w-[319px] sm:h-[505px] absolute bottom-0 left-[30%] z-10 " />

                            <motion.img
                                initial = {{opacity: 0, }}
                                whileInView = {{opacity: 1, }}
                                transition = {{duration: 2 }}
                                src = {visual} alt ="visual" className = "absolute top-12 sm:bottom-[400px] sm:left-0 w-[139px] h-[152px] sm:w-[207px] sm:h-[225px]" 
                            />
                            ...
                            <motion.img 
                                ...
                                src = {listening} alt ="listening" className = "absolute sm:top-[-20px] left-32 sm:left-40 w-[97px] h-[215px] sm:w-[145px] sm:h-[318px]" 
                            />
                            <motion.img 
                                initial = {{opacity: 0, }}
                                whileInView = {{opacity: 1, }}
                                transition = {{duration: 2, delay: 0.7 }}
                                src = {kinaesthetic} alt ="kinaesthetic" className = "absolute top-16 right-[-10px] sm:top-20 sm:right-0 w-[178px] h-[135px] sm:w-[263px] sm:h-[200px]" 
                            />
                    </div>

                    <div className="flex flex-col items-center gap-y-3 order-1 sm:order-2">
                        <p className="font-causten font-normal text-[16px] leading-[23px] sm:text-[24px] w-[307px] sm:leading-[33px] text-black text-center sm:w-[410px]">We celebrate the uniqueness of every learner through diverse methodologies. From experiential activities to structured problem-solving, our approach adapts to diverse learning styles, ensuring every learner thrives in their own way.</p>
                        <h3 className="font-causten font-bold text-[24px] leading-[24px] sm:text-[32px] sm:leading-[84px] my-7 sm:my-0 text-orange">Contact learning advisory today!</h3>

                        <Link to = "/contact"><button className="w-[188px] h-[48px] sm:w-[265px] sm:h-[72px] bg-brown text-white font-causten text-[20px] leading-[20px] sm:text-[24px] sm:leading-[24px] font-bold rounded-[16px]">Contact now</button></Link>
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-screen-xl mx-auto px-5 pt-12 sm:px-7 xl:px-20 sm:pt-44 pb-32  ">
                    <div className="flex flex-row flex-wrap justify-center items-start sm:justify-between ">
                        <div>
                            ...
                            <p className="font-causten font-semibold text-center sm:text-left text-[16px] leading-[23px] sm:text-[24px] sm:leading-[27px] w-[344px] sm:w-[508px] text-offwhite sm:mt-16 mt-9">Ruh Continuum School is an initiative by SSVM Institutions, a group of K-12 schools founded in 1998, with 2 international school brands and 10 campuses under its wings.</p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-y-9 sm:gap-y-16 sm:gap-x-20 items-center mt-12 sm:mt-0">
                            <div className="flex flex-col items-center gap-y-2 sm:gap-y-0 ">
                                <img src={campus_icon} alt="Campus-icon" className="sm:w-[153px] sm:h-[165px] w-[106px] h-[115px]" />
                                <h5 className="font-causten font-bold text-[16px] leading-[23px] sm:text-[24px] sm:leading-[32px] text-offwhite mt-2">10+ Campuses</h5>
                            </div>

                            <div className="flex flex-col items-center gap-y-2 sm:gap-y-0 mt-7">
                                <img src={curricular_icon} alt="Curricular-Icon" className="sm:w-[106px] sm:h-[133px] w-[73px] h-[92px]" />
                                <h5 className="font-causten font-bold text-[16px] leading-[23px] sm:text-[24px] sm:leading-[32px] text-offwhite mt-2">6+ Curriculam</h5>
                            </div>

                            <div className="flex flex-col items-center gap-y-2 sm:gap-y-0 ">
                                <img src={faculty_icon} alt="Faculty-icon" className="sm:w-[153px] sm:h-[139px] w-[106px] h-[96px]" />
                                <h5 className="font-causten font-bold text-[16px] leading-[23px] sm:text-[24px] sm:leading-[32px] text-offwhite mt-2 w-[142px] text-center">500+ Trained Faculty</h5>
                            </div>

                            <div className="flex flex-col items-center gap-y-2 sm:gap-y-0 ">
                                <img src={student_impact_icon} alt="Students-Impact-Icon" className="sm:w-[129px] sm:h-[141px] w-[89px] h-[98px]"/>
                                <h5 className="font-causten font-bold text-[16px] leading-[23px] sm:text-[24px] sm:leading-[32px] text-offwhite mt-2 w-[186px] text-center">10,000+ Students Lives Impacted</h5>
                            </div>
            ...
            <div className="max-w-screen-xl mx-auto my-12 sm:my-0" data-aos="fade-up">
                <h1 className="font-aelyn text-[42px] leading-[54px] text-brown text-center font-extrabold mt-12">Our Campuses</h1>
                ...
                >
                    <SwiperSlide><img src={kidscasa_alangombu} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                    <SwiperSlide><img src={kidscasa_mettupalayam} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                    <SwiperSlide><img src={kidscasa_saibabcolony} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                    <SwiperSlide><img src={kidscasa_tirupur} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                    <SwiperSlide><img src={ruh_damunagar} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                    <SwiperSlide><img src={ruh_racecourse} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                    <SwiperSlide><img src={ruh_singanallur} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                    <SwiperSlide><img src={ssvm_funmall} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                    <SwiperSlide><img src={ssvm_mettupalayam} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                    <SwiperSlide><img src={ssvm_nambiyur} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                    <SwiperSlide><img src={ssvm_singanallur} alt="campus-logo" className="w-[173px] h-[46px] sm:w-[223px] sm:h-[60px]" /></SwiperSlide>
                </Swiper>
            ...
            <div className="max-w-[992px] mx-auto sm:my-52 my-7 " data-aos="fade-up">
                <div className="flex flex-row items-center relative md:flex-nowrap flex-wrap">
                    ...
                    <div className="bg-brown flex flex-col sm:px-16 sm:py-20 py-3 px-5 w-[361px] overflow-hidden h-[424px] sm:w-[520px] sm:h-[602px] mx-auto sm:mx-0  z-0">
                        ...
                        <h5 className="font-caveat text-[24px] sm:text-[28px] leading-[33px] text-yellow sm:text-yellow mt-12 italic">Dr.Manimekalai Mohan</h5>
                        <p className="font-causten text-[14px] font-extralight text-offwhite mt-2">Founder & Managing Trustee, SSVM Group of Instituitions</p>

                    </div>
                    
                    
                    <img src={founder_image} alt="Co-Founder-Image" className="w-[340px] h-[537px] mx-auto mt-[-60px] sm:w-[536px] sm:h-[772px] z-10 order-2 sm:absolute sm:right-7 top-[-20px] "/>
            ...
            <div className="py-20  swiper-membership" data-aos="fade-up">
                ...
                <h1 className="font-aelyn text-[47px] leading-[54px] font-medium text-center text-brown mt-2">Memberships & Accrediations</h1>
               ...
               <div className = "flex gap-x-3 sm:gap-x-12 overflow-x-hidden">
                <motion.div 
                    ...
                    >
                        ...
                        <img src={igbc_logo} alt="afs_logo" className="w-[74.85px] h-[75px] sm:w-[149px] sm:h-[150px]"/>    
                        <img src={mca_logo} alt="afs_logo" className="w-[75px] h-[75px] sm:w-[150px] sm:h-[150px]"/>    
                        <img src={dais_logo} alt="afs_logo" className="w-[75px] h-[75px] sm:w-[156px] sm:h-[150px]"/>   
                        <img src={ielts_logo} alt="afs_logo" className="w-[75px] h-[75px] sm:w-[168px] sm:h-[150px]"/>  
                        <img src={foryoung_logo} alt="afs_logo" className="w-[75px] h-[75px] sm:w-[148px] sm:h-[150px]"/>   
                        <img src={internationcouncil_logo} alt="afs_logo" className="w-[75px] h-[75px] sm:w-[171px] sm:h-[150px]"/>     
                        <img src={nabet_logo} alt="afs_logo" className="w-[75px] h-[75px] sm:w-[168px] sm:h-[150px]"/>  
               ...
               <div className = "flex flex-row gap-x-3 sm:gap-x-12 overflow-x-hidden">
                    ...
                    >
                        ...
                        <img src={ew_logo} alt="afs_logo" className="w-[75px] h-[75px] sm:w-[150px] sm:h-[150px]"/>
                        <img src={aiaa_logo} alt="afs_logo" className="w-[75px] h-[75px] sm:w-[150px] sm:h-[150px]"/>
                        <img src={sat_logo} alt="afs_logo" className="w-[120px] h-[75px] sm:w-[231px] sm:h-[150px]"/>
                        <img src={wacp_logo} alt="afs_logo" className="w-[149px] h-[75px] sm:w-[346px] sm:h-[150px]"/>
                    </motion.div>
               ...
               <div className = "flex flex-row gap-x-3 sm:gap-x-12 overflow-x-hidden">
                    ...
                    >
                        ...
                        <img src={ted_logo} alt="afs_logo" className="w-[273px] h-[75px] sm:w-[547px] sm:h-[150px]"/>
                        <img src={diamond_logo} alt="afs_logo" className="w-[106px] h-[75px] sm:w-[213px] sm:h-[150px]"/>
                        <img src={cambridgeassesment_logo} alt="afs_logo" className="w-[124px] h-[75px] sm:w-[249px] sm:h-[150px]"/>     
                    </motion.div>
            ...
            {/* Testimonial Section */}
            <div className = "bg-yellow pt-20 overflow-x-hidden  h-[1000px] " data-aos= "fade-up">
                <div className="max-w-7xl mx-auto px-5">
                    <div className = "">
                        <h2 className = "font-causten text-[40px] font-bold leading-[55px] text-orange">What our lovely</h2>
                        <h1 className = "font-aelyn text-[40px] font-bold leading-[51px] text-brown w-[277px]">parents say about us</h1>
                    </div>
